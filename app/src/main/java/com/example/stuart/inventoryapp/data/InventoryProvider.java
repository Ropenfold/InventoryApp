...
public class InventoryProvider extends ContentProvider {
    ...
    /** URI matcher code for the content URI for the cricket table */
    private static final int ITEMS = 100;

    /** URI matcher code for the content URI for a single Item in the cricket table */
    private  static final int ITEM_ID = 101;

    /**
     *UriMatcher object to match a content URI to a corresponding code.
     * The input passed into the constructor represents the code to return for the
     * root URI. It is common to use NO_MATCH as the input for this case.
     */
    ...
    static {
        /**
         * The calls to addURI() go there, for all of the content URI pattersn that the provider
         * should recognize. All paths to the UriMatcher have a corresponding code to return when
         * a match is found.
         */

        //Code when acting on the whole item table
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryContract.PATH_CRICKET_ITEMS, ITEMS);

        //code when acting on a single line in the cricket database
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryContract.PATH_CRICKET_ITEMS + "/#", ITEM_ID);
    ...
    public boolean onCreate() {
        ...
        //create and initialize a InventoryDBHelper object to gain access to the item database
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        // Figure out if the URI matcher can match the URI up to a specific code
        ...
        switch (match) {
            ...
            case ITEM_ID:
                ...
                // For an example URI such as "content://com.example.stuart.inventoryapp/item/3,
    ...
    /**
     * Insert a cricket item into the database with the given content values. Return the content URI
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        String brand = values.getAsString(InventoryEntry.COLUMN_ITEM_BRAND);
        if (brand == null){
        ...
        String price = values.getAsString(InventoryEntry.COLUMUN_ITEM_PRICE);
        if(price == null){
        ...
        //uri: content://com.example.android.item/cricket
    ...
    private int updateItem (Uri uri, ContentValues values, String selection, String[] selectionArgs){
        ...
        // check that the item value is not null.
        ...
        // If the {@Link InventoryEntry#COLUMN_ITEM_BRAND} key is present,
        // check that the brand is not null.
        if (values.containsKey(InventoryEntry.COLUMN_ITEM_BRAND)) {
            String brand = values.getAsString(InventoryEntry.COLUMN_ITEM_BRAND);
                if (brand == null){
                    throw new IllegalArgumentException("Item requires a brand");
                }
        ...
        // check that the price is valid.
        if (values.containsKey(InventoryEntry.COLUMUN_ITEM_PRICE)){
            Integer price = values.getAsInteger(InventoryEntry.COLUMUN_ITEM_PRICE);
